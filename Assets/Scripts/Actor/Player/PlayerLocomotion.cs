...
public class PlayerLocomotion : MonoBehaviour
{
    ...
    private void HandleRotation(float delta)
    {
        ...
        //targetDir = myTransform.forward * inputHandler.vertical;
        //targetDir += myTransform.right * inputHandler.horizontal;
        ...
        //Debug.Log("myTransform.rotation:" + myTransform.rotation + "  " + "tr:" + tr);
        Quaternion targetRotation = Quaternion.Slerp(myTransform.rotation, tr, rs * delta);
        myTransform.rotation = targetRotation;

        //myTransform.forward = Vector3.Slerp(myTransform.forward, targetDir, 0.2f);
    }
    ...
    public void HandleMovement(float delta)
    {
        ...
        if (inputHandler.sprintingFlag && inputHandler.moveAmount > 0.5f)
        {
            speed = sprintSpeed;
